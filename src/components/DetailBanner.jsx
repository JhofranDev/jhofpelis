...
const DetailBanner = ({ saved, movie, handleClickSave, handleClickRemove }) => {
  return (
    <div className='px-10 w-[50%] h-[300px] absolute top-[30%] left-0 flex flex-col justify-center items-start bg-gradient-to-r from-black via-black/ 50 to-black/10 text-white'>
      ...
      {saved 
        ?
          <button 
            className='
              bg-zinc-500 py-2 px-5 rounded-md text-sm font-medium my-5 hover:bg-zinc-700
            '
